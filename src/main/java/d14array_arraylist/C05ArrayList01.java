...
public class C05ArrayList01 {
    public static void main(String[] args) {
        ...
        //ArrayList nedir?
        /* ArrayList bir class'tır. ArrayList dinamik bir array yapısıdır. Bu, ArrayList'in boyutunun, elemanlar ekleme
           veya çıkarma sırasında otomatik olarak ayarlanabileceği anlamına gelir.
        ...
        /* 1)Array'ler primitive data type'lari ve reference'lari depolayabilir
           ...
           6) Java'da generic (kapsamli) türler (<> ile belirtilen türler) için yalnızca referans veri türleri
              kullanılabilir. Primitive veri türleri (örneğin int, char, boolean, double, vb.) doğrudan generic
              türlerin içine yerleştirilemez. Bu nedenle, özel bir durumla karşılaştığınızda, bu türleri ilgili
              sınıflarla sarmalamanız (wrapper) gerekir.    */

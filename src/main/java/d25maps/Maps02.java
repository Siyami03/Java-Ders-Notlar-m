...
public class Maps02 {
    public static void main(String[] args) {
        ...
        //1) replace() methodu value’lari key’leri kullanarak update etmeye yarar. Aynı işlemi put ile yapmak da teknik
        // olarak işe yarar, ancak replace kullanmak,kodunuzu okuyan diğer geliştiricilere ve size daha net bilgi verir.
        ...
        //3)putIfAbsent() metodu, belirtilen key ve value çiftini, key Map’te yoksa Map’e ekler. Key Map’te zaten varsa,
        //metodun hiçbir etkisi olmaz.
        ...
        System.out.println(stdNames);                     //{Can=19, Ahmet=41, Tom=45, Veli=63, Ayse=23, Ali=18}
        ...
        System.out.println(stdNames.getOrDefault("Tom",18));  //45

        System.out.println(stdNames.get("Jerry"));                             //null
        System.out.println(stdNames.getOrDefault("Jerry",18));//18
        ...
        System.out.println(stdNames);                          // Can silinmez, value'su 19 olsaydi silinirdi

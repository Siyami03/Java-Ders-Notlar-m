...
public class Maps01 {
    public static void main(String[] args) {
        ...
        System.out.println(yas);                    //25   Kücük büyük harfe duyarlı. Uyulmazsa null verir.
        ...
        //Java’da Map.Entry kullanarak bir Set üzerinde loop yapabilir ve hem anahtarları (getKey()) hem de değerleri
        //(getValue()) elde edebilirsiniz.

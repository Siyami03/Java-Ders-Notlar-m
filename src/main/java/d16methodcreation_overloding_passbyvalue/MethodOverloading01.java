...
public class MethodOverloading01 {
    ...
    //ornek : Toplama islemi yapan bir method olusturun ve sonra da overload edin
    ...
    public static void add(int a, int b, int c){
        ...
        /*Soru 1: private method'lar overload edilebilir mi?
         Cevap 1: private method'lar overload edilebilirler cunku; overload islemi tek class icinde yapilir, private
         methodlar ayni class'in icinden ulasilabilir oldugundan overload'a engel degildir.

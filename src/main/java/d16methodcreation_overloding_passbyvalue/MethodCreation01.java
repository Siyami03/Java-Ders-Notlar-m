...
public class MethodCreation01 {
    ...
    public static void main(String[] args) {
        ...
        /* Method Creation - Metot Olusturma        Java'da method nasil olusturulur?
        ...
        int sonuc = toplama(3,5);              //1-method call
                                                     //2-return verisini içinde tutar
                                                     //toplama (3,5) değerlerine argüman denir
        System.out.println("sonuc = " + sonuc);      //sonuç = 8

...
public enum Cities {
   ...
   enum'un temel avantajları şunlardır:
    ...
    4) enum icerisine koymus oldugumuz her bir sabit default olarak public static ve final'dir.
       (Burada iller kastediliyor-enum tanımlarken bu anahtar kelmeleri sabitlern önüne yazmak gerekmez ve yazılamaz da;
       dilin sözdizimi bunu desteklemez)
    5) Bu nedenle enum icindeki her bir sabit dataya enum ismi yazarak ulasabilirsiniz
    6) enum'daki constructor yeni bir object olusturmak icin degil, enum'in icindeki her bir sabit datanin icindeki
    ...
    public int getPlateCode()     { return plateCode;    }

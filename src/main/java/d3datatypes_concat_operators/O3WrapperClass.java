...
public class O3WrapperClass {
    ...
    public static void main(String[] args) {
        ...
        Wrapper sınıflar, Java'nın primitif veri türlerini object olarak temsil etmek için kullandığı class'lardir.
        Bu özellik, primitive veri türlerini koleksiyonlarda (örneğin ArrayList gibi) kullanabilmek için oldukça
        kullanışlıdır, çünkü Java'da koleksiyonlar sadece Object referans türlerini kabul eder.

        Ayrica en onemlisi girdigimiz veriler uzerinde method kullaniminin da yolunu acar.*/

        //--------------------------------------------------------------------------------------------------------------

        //Wraper'ler büyük harfle başlar. Çünkü Class'dırlar.
        ...
        //Ornek;
        int i = 12;
        //i. yapınca method açılmaz.
        Integer k = 12;
        //k. yapınca methodlar açılır. Burasi class'tir.
        ...
        //Ornek 1 : primitive int’i wrapper Integer’a ceviriniz (aoutoboxing)
        int num = 13;
        Integer wrapperNum = num;

        //Ornek 2 : Wrapper Byte'i primitive byte'a çeviriniz (unboxing)
        Byte  s = 19;
        byte primitiveS = s;

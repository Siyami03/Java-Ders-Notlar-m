...
public class CourseRunner {
    public static void main(String[] args) {
        ...
        //allMatch metodu, akıştaki (stream) tüm öğelerin belirli bir koşulu karşılayıp karşılamadığını kontrol eder.
        //Eğer akıştaki tüm öğeler bu koşulu sağlarsa true döndürür, aksi takdirde false döndürür.(VE gibi)
        ...
        //a) sorted, Stream içerisindeki elemanları doğal sıralamasına göre sıralar.(kucukten buyuge) Özel bir sıralama
        //için bir Comparator’da alabilir.
        ...
        //8) Tum course object’lerini average score’a gore kucukten buyuge diziniz ve ilk ikisi haric liste halinde
        ...
        //9) Tum course object'lerini average score'a gore kucukten buyuge diziniz ve ilk ucunu liste halinde console'a
        //yazdiriniz.
        ...
        //10)Kursta bulunan ogrenci sayilarina gore buyukten kucuge sirali bir sekilde Listin icinde veren kodu yaziniz

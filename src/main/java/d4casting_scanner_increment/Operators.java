...
public class Operators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ucretMiktari / ogrenciSayisi);   //2.5 Büyüklükten kasit daha fazla bilgi saklayabilmektir.

        //--------------------------------------------------------------------------------------------------------------

        /*2) Java da "logical operator" lar.
       ==> AND (&&) isleminden true alabilmek icin her sey true olmalidir. AND islemini carpma olarak dusunebiliriz.
       ...
       <, >, <=, >=, ==, !=
       Not: Karsilastirma operatorlerini kullandiginizda sonucu kesinlikle boolean (true, false) alirsiniz*/
        ...
        /*Type Casting (Tip Dönüşümü): Sayisal primitive data tiplerinin birbirine donusturulmesine Type Casting denir
        Numeric (sayisal) Data Type ==> byte - short - int - long - float - double */

        /*Not 1: Kucuk data type'larini buyuk data type'larina cevirmeyi Java otomatik olarak yapabilir. Bu isleme
        "AutoWidening" (Otomatik genisletme) denir*/
        ...
        System.out.println(weightShort);     //313 . Eğer sayi biraz daha büyük olsaydi sonuç doğru çıkmayacaktı.
        // Burada sınırı aşmadigi icin dogru cikti.

        //--------------------------------------------------------------------------------------------------------------

        /* Java Library  : Java'da kütüphane, belirli bir işlevselliği sağlayan class'lar, interface'ler ve metotlar
        koleksiyonudur.*/
        //.jar (java archive) dagitilirlar.
        //Java Standart Kutuphanesi
        //Kutuphaneyi kullanabilmek icin import keyword'u kullanilir.
        //ornek kutuphane ; Java.lang ==> otomatik olarak her java programinda import edilir.
        //Java.util
        //Java ucuncu taraf kutuphaneler ==> Apache Commons      Spring       Hibernate   Selenium

...
public class Scanner03 {
    ...
    public static void main(String[] args) {
       ...
       //Ornek3: Kullanicidan iki sayi alip 4 islem yapan ve islemlerin sonuclarini ekrana yazdiran kodu yaziniz.
        ...
        System.out.println("Bolüm  : " + String.format("%.2f",firstNumber / secondNumber));

        //Bolum : 1.6037735849056605 cikti. Bu sonucun virgulden sonra iki basamak olmasini istiyoruz. Bunun icin:
        //System.out.println("Bolum : " + String.format("%.2f",(firstNumber / secondNumber))); seklinde yapiyoruz.

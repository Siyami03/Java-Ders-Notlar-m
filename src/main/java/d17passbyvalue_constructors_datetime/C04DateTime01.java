...
public class C04DateTime01 {
    public static void main(String[] args) {
        ...
        LocalDate myDate = LocalDate.now();    //now() methodu statik bir methoddur. Class ismiyle çağrılır.
        ...
        System.out.println(gun2);                           //TUESDAY  - ENUM yapısı
        ...
        //*ornek 7: istediğimiz tarihi yazdırabiliriz. Kullanılan method :
        ...
        //Kullanıcadan alıanan verilerle bir tarih oluşturalaim

        LocalDate girilenTarih = LocalDate.of(year,month,day);

        if(girilenTarih.isBefore(LocalDate.now())){                         //girilen tarih şu andan önce ise

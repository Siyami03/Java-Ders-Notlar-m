...
public class InstanceBlock1 {
    ...
    //instance block
    {
        System.out.println("Merhaba java kullanıcılar");
    }
    ...
    public static void main(String[] args) {
        ...
        /* instance (örnek) blok, bir Class'in her Object'i (nesnesi) oluşturulduğunda çalışan bir kod bloğudur.
           ...
           Örneğin: instance blok, her otomobil Object'i oluşturulduğunda çalışır ve otomobilin rengini siyah ve yakıt
           türünü benzin olarak başlatır.Bu, her yeni otomobilin aynı başlangıç değerleriyle başlamasını sağlar.

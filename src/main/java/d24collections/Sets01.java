...
public class Sets01 {
    public static void main(String[] args) {
        ...
        1) HashSet: Bu set, elemanların hash kodlarına göre depolandığı bir settir. Elemanlar, her birinin benzersiz bir
        hash kodu (kimlik numarası) ile depolandığı bir yapıda tutulur. Bir eleman eklediğinizde, bu elemanın hash kodu
        hesaplanır ve o hash koduna karşılık gelen bir hücreye yerleştirilir. HashSet'ler, en hızlı performansı sunar.
        Ancak, elemanların sırasını korumazlar.null'i eleman olarak kabul ederler */

        //Hash Cod'u gormek istersek

        String a = "Ali Can";
        System.out.println(a.hashCode());                       //748135950
        String b = "Aliye Can";
        System.out.println(b.hashCode());                      //-18438246

        //--------------------------------------------------------------------------------------------------------------

        /*2) LinkedHashSet:Bu set, elemanların eklenme sırasına göre(insertion order) depolandığı bir settir.
        LinkedHashSet class'i, HashSet class'inin child'idir. LinkedHashSet'ler, elemanların sırasını korumaya ihtiyaç
        duyulan uygulamalar için iyi bir seçimdir. Ancak, HashSet'lerden daha yavaş performans sunarlar. (orta)
        ...
        HashSet'ler ve LinkedHashSet'lerden daha yavaş performans sunarlar. Java'da TreeSet, SortedSet arayüzünü
        (interface) uygulayan bir class'tir. Bu nedenle, TreeSet bir Sorted Set'tir.   */
        ...
        hs.add("Kerem");
        System.out.println(hs); //tekrarli eleman hata vermez, tekrarli elemanin uzerine yazar[Kerem, Sinan, Tuba, Onur]

        hs.add(null);
        System.out.println(hs);             //[Kerem, null, Sinan, Tuba, Onur]. null'ı eleman olarak kabul eder.
        ...
        //new ile üretmediğimiz için yeni eleman ekleyemeyiz veya silemeyiz. Onun için en iyisi Hashset kullanmak.
        Set<String> hs3 = Set.of("Ayse","Fatma");
        System.out.println(hs3);                        //[Fatma, Ayse]
        ...
        // alt + imleci tutu çek. Hepsine aynı işlemi yapmak için
        ...
        ts.add('R');
        ts.add('U');
        //ts.add(null);                       sıralama yaparak dizdiği için null eklenemez. null'ın sıralamada yeri yok.

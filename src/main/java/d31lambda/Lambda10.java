...
public class Lambda10 {
    ...
    //removeIf() metodu, koleksiyonlardaki (özellikle List, Set gibi) elemanları belirli bir koşula göre kaldırmak için
    //kullanılır.removeIf metodu Collection arayüzünde tanımlıdır, stream kullanilmadan cagirilir

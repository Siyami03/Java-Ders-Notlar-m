...
public class O4DoWhileLoops01 {
    public static void main(String[] args) {
        ...
        // koşul kontrolü yapılırken bile olsa, en az bir kez çalışacaktır. (Örneğin banka kartını soktuğumuzda
        // hoşgeldiniz demesi
        //--------------------------------------------------------------------------------------------------------------
        /*        Baslangic degeri
                  do {
        ...
        //while loop ile do while loop fark nedir?

...
public class E08 {
    public static void main(String[] args) throws IOException {
        ...
        /*Aciklama: FileInputStream kullanacagiz. Bir class'tir.FileInputStream sınıfı, Java'da dosyaları bayt (byte)
          bazlı okumak için kullanılır. Bu sınıf, Java'nın java.io paketinin bir parçasıdır. Genellikle metin dosyaları,
          resimler, ses dosyaları vb. dosya türlerini okumak için kullanılır.
        ...
        /*  interview sorusu ==> throw ile throws arasindaki farklar nelerdir?
        ...
        while ((k = fis.read()) != -1){
            //System.out.print(k);                      7497118973210711110897121100105114

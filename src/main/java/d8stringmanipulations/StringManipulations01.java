...
public class StringManipulations01 {
    public static void main(String[] args) {
        ...
        boolean isStart = s.startsWith("J");  //Java yazsak da kontrol eder.
        ...
        boolean isEnd = s.endsWith("easy");  //y yazsak da kontrol eder. Ancak dikkat büyük/küçük harfe duyarlı

...
public class Sb01 {
    public static void main(String[] args) {
        ...
        //4-replace(int start-dahil, int end-haric, String str): Belirtilen indexteki karakterleri verilen stringle
        // değiştirir.
        ...
        //5-insert(int offset, String str): Belirtilen konumdan itibaren verilen stringi ekler. //offset aslinda index
        // degildir ama index’mis gibi sayabiliriz
        ...
        System.out.println(result);                      //15 (ASC II tablosunda 90-75=15
